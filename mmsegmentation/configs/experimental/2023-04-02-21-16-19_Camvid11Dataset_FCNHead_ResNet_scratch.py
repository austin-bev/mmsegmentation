    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name=
                '2023-04-02-21-16-19_Camvid11Dataset_FCNHead_ResNet_scratch'))
    ])
...
work_dir = './work_dirs/experimentation/2023-04-02-21-16-19_Camvid11Dataset_FCNHead_ResNet_scratch'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
