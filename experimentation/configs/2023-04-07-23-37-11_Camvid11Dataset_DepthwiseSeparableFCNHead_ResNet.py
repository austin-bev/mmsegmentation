    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name=
                '2023-04-07-23-37-11_Camvid11Dataset_DepthwiseSeparableFCNHead_ResNet'
            ))
    ])
...
work_dir = './work_dirs/experimentation/2023-04-07-23-37-11_Camvid11Dataset_DepthwiseSeparableFCNHead_ResNet'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
