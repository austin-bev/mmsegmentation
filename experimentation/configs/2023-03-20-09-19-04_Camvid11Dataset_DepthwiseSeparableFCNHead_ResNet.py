    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name=
                '2023-03-20-09-19-04_Camvid11Dataset_DepthwiseSeparableFCNHead_ResNet'
            ))
    ])
...
work_dir = './work_dirs/experimentation/2023-03-20-09-19-04_Camvid11Dataset_DepthwiseSeparableFCNHead_ResNet'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
