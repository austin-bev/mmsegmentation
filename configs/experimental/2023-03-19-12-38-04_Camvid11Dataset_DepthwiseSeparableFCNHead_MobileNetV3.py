...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            by_epoch=True,
            init_kwargs=dict(
                entity='WANDB NAME HERE',
                project='honours-experimentation',
                config=dict(
                    learning_rate=0.045,
                    momentum=0.9,
                    batch_size=8,
                    ...
                    is_pretrained=True),
                name=
                '2023-03-19-12-38-04_Camvid11Dataset_DepthwiseSeparableFCNHead_MobileNetV3'
            ))
    ])
...
work_dir = './work_dirs/experimentation/2023-03-19-12-38-04_Camvid11Dataset_DepthwiseSeparableFCNHead_MobileNetV3'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
