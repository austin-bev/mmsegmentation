        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                config=dict(
                    ...
                    comment='ResNet18'),
                name=
                '2023-03-19-23-41-55_Camvid11Dataset_DepthwiseSeparableFCNHead_ResNet'
            ))
    ])
...
work_dir = './work_dirs/experimentation/2023-03-19-23-41-55_Camvid11Dataset_DepthwiseSeparableFCNHead_ResNet'
seed = 0
gpu_ids = range(0, 1)
device = 'cuda'
